...
function ClickableCard ({ href, icon, title, body, button, big = false }) {
  return (
    <a className={`relative flex flex-col items-center p-6 bg-white cursor-pointer rounded shadow-xl border-2 ${big ? 'col-span-full' : 'col-span-full sm:col-span-1'} transition ease-in-out duration-150 hover:scale-105`} href = { href } target = "__blank" >
