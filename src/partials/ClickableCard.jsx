...
function ClickableCard ({ href, icon, title, body, button }) {
  return (
    <a className="relative flex flex-col items-center p-6 bg-white cursor-pointer rounded shadow-xl border-2 transition ease-in-out duration-150 hover:scale-105 col-span-2 sm:col-span-1" href={href} target="__blank">
