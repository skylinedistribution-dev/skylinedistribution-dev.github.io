...
function NavMenu () {
  return (
    <>
      ...
      <li>
        <HashLink to="#connect-with-us" className="font-medium text-lg text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">Connect With Us</HashLink>
      </li>
    </>
  )
};
