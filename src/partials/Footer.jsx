  ...
  return (
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 ">
        ...
        {/* Top area: Blocks */}
        <div className="flex justify-evenly gap-4 items-center py-8 md:py-12 border-t border-gray-200">
          ...
          {/* 5th block */}
          <div>
            <h6 className="font-bold text-gray-800 text-md sm:text-2xl mb-2">Contact Us</h6>
            <ul className="text-sm sm:text-xl text-gray-600">
